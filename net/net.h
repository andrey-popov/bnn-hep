...
/* Added function prototype net_grad_w to manage weighted training cases.
 * -- Andrey Popov
 */
...
void net_grad (net_params *, net_params *, net_values *, net_values *, 
               net_arch *, net_flags *);
void net_grad_w (net_params *, net_params *, net_values *, net_values *, 
                 net_arch *, net_flags *, double);
